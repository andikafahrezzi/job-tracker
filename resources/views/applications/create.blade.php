...
@section('page-title', 'Tambah Lamaran')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
        <!-- Card Header -->
        <div class="bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-600 px-6 sm:px-8 py-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-white">Tambah Lamaran Baru</h1>
                    <p class="text-blue-100 text-sm mt-1">Isi form di bawah untuk menambahkan lamaran kerja</p>
                </div>
            </div>
        </div>

        <!-- Form Body -->
        <form method="POST" action="{{ route('applications.store') }}" class="p-6 sm:p-8 space-y-6">
            @csrf
            ...
            <div class="space-y-2">
                ...
                <textarea type="text" 
                       ...
                       name="notes" 
                       value="{{ old('notes') }}"
                       placeholder="Contoh: dapet di linkedin"
                       class="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition-all outline-none text-gray-900 placeholder-gray-400 @error('position') border-red-500 @enderror"
                       required>
                @error('notes')
                    <p class="flex items-center gap-1 text-sm text-red-600 font-medium mt-1">
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-3">
                    ...
                    <button type="submit" 
                            class="group inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-xl hover:from-blue-700 hover:to-indigo-700 shadow-lg shadow-blue-500/50 hover:shadow-xl hover:shadow-blue-500/60 transition-all transform hover:scale-105">
    ...
    <div class="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
        <div class="flex gap-4">
            ...
            <div>
                <h3 class="text-sm font-bold text-gray-900 mb-2">💡 Tips Mengelola Lamaran</h3>
                <ul class="text-sm text-gray-700 space-y-1">
                    <li class="flex items-start gap-2">
                        <span class="text-blue-600 font-bold">•</span>
                        <span>Update status secara berkala untuk tracking yang lebih baik</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-blue-600 font-bold">•</span>
                        <span>Catat estimasi gaji untuk perbandingan antar perusahaan</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-blue-600 font-bold">•</span>
                        <span>Gunakan nama perusahaan yang lengkap dan jelas</span>
                    </li>
                </ul>
            </div>
        </div>
